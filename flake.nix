...
EOF
          ...
          initfsToolsSrc = pkgs.runCommand "initfs-tools-src" {
          ...
          initfsTools = pkgs.stdenv.mkDerivation {
            ...
            nativeBuildInputs = [ rustToolchain pkgs.python3 ];
...
INITRC
          ...
          diskImage = pkgs.stdenv.mkDerivation {
            ...
            buildInputs = [ base uutils minishell ion ];
...
PROFILE
          ...
          mkImage = { configName ? "desktop", filesystemSize ? 650 }:
        ...
        in
        {
          ...
          packages = {
            ...
            image-server = mkImage { configName = "server"; filesystemSize = 256; };
          };
